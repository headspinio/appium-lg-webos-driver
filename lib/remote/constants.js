export const AUTH_PAYLOAD = Object.freeze(
  /** @type {const} */ ({
    forcePairing: false,
    manifest: {
      appVersion: '1.1',
...
/**
 * @typedef {typeof AUTH_PAYLOAD & {'client-key'?: string}} AuthPayload
 */

export const MsgType = /** @type {const} */ ({
  ERROR: 'error',
...
/**
 * @typedef {import("type-fest").ValueOf<typeof MsgType>} MessageType
 */
