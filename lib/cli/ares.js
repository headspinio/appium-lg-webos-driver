 ...
 */
export const assertLgHome = _.once(async function assertLgHome() {
  const lgHome = path.resolve(LG_WEBOS_TV_SDK_HOME);
  const aresCliPath = path.resolve(lgHome, ...WEBOS_CLI_PATH_PREFIX, ARES);
  try {
